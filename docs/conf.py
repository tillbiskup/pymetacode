...
latex_documents = [
    (master_doc, 'pymetacode.tex', 'pymetacode Documentation',
     'Till Biskup', 'manual'),
]
...
man_pages = [
    (master_doc, 'pymetacode', 'pymetacode Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pymetacode', 'pymetacode Documentation',
     author, 'pymetacode', 'A Python package helping to write and maintain Python packages.',
     'Miscellaneous'),
]
