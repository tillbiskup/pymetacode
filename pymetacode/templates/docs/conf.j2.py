...
copyright = '{{ package.year }}, {{ package.author }}'
...
latex_documents = [
    (master_doc, '{{ package.name }}.tex', '{{ package.name }} Documentation',
     '{{ package.author }}', 'manual'),
]
...
texinfo_documents = [
    (master_doc, '{{ package.name }}', '{{ package.name }} Documentation',
     author, '{{ package.name }}', '{{ package.description }}',
     'Miscellaneous'),
]
